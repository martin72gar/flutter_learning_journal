...
class MyHomePageDefault extends StatefulWidget {
  const MyHomePageDefault({super.key, required this.title});

  final String title;

  @override
  State<MyHomePageDefault> createState() => _MyHomePageDefaultState();
}

class _MyHomePageDefaultState extends State<MyHomePageDefault> {
  int _counter = 0;
